...
export const TailwindIcon = ({ className, ...rest }) => (
  ...
  >
    <path
      fill="url(#a)"
      d="M12 4.781c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624 1.176 1.194 2.538 2.576 5.512 2.576 3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.623C16.336 6.163 14.974 4.78 12 4.78Zm-6 7.2c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.229 1.565.89 2.288 1.624C7.664 17.799 9.026 19.18 12 19.18c3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.623C10.336 13.363 8.974 11.98 6 11.98Z"
    />
    <defs>
      <linearGradient
        id="a"
